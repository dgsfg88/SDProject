...
/**
 * Classe che corrisponde ad un client RMI, serve ad inviare i messaggi in
 * uscita
 * 
 * @author Andrea
 * 
...
public class OutcomingClient extends RmiStarter {
	 ...
	 * 
	 * @param serverID
	 *            Server con cui si desidera comunicare
	 */
	...
	protected void doTask(String serverID, Task<Integer> task) {
		...
		try {
			...
			result = 0;
			System.out.println("Connection refused to host " + serverID + ": " + host
					+ ":" + port);
		}
	}
